...
import com.ariskk.raft.model.Message._
import com.ariskk.raft.model.RaftException.{ InvalidStateException, StorageException }
...
object Raft {
  ...
  val LeaderHeartbeat: Duration = 50.milliseconds
